	...
	return (
		<main className="">
			<div className="flex flex-col gap-8 items-center sm:items-start w-full px-3 md:px-0">
				...
				<section className="flex flex-col items-center md:flex-row gap-10 w-full justify-center max-w-5xl bg-white">
					<TokenBalance />
					<WatchAccount />
				</section>
						...
						<CardContent className="space-y-7">
							...
							<div className="space-y-1">
								...
								<div className="space-y-1">
									{[
										{
											url: "https://github.com/MetaMask/metamask-sdk-examples/tree/main/examples/quickstart",
											text: "Next.js + Wagmi",
										},
									].map((item) => (
										<a
